...
export const metadata: Metadata = {
  title: 'Sistema Luz Cuántica®️ | Arquitectura de Transformación Consciente',
  description: 'Estructura técnica de transformación consciente. Arquitectura cerrada, protocolos definidos, excelencia operativa. Evaluación Energética, Reiki Energy Quantum®️, Constelaciones Familiares Cuánticas Estelares y más.',
  ...
  openGraph: {
    ...
    siteName: 'Sistema Luz Cuántica®️',
  },
  twitter: {
