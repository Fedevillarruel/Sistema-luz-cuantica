...
export const SERVICES: Service[] = [
  ...
  {
    id: 'libros-novedades',
    name: 'Sistema Luz Cuántica® — El Libro',
    tagline: 'Descargá gratis. Entendé el sistema desde adentro.',
    description: 'El documento oficial que explica qué es el Sistema Luz Cuántica®, cómo funciona, qué herramientas lo integran y qué podés esperar antes de iniciar. Lectura recomendada antes de cualquier consulta.',
    bullets: [
      'Descarga gratuita e inmediata en PDF',
      'Marco conceptual completo del sistema',
      'Qué es y qué NO es cada herramienta',
      'Protocolo de ingreso explicado paso a paso',
      'Ideal antes de tu primera Evaluación Energética',
    ],
    requiresEvaluation: false,
    category: 'personal',
    ctaText: 'Descargar Gratis',
    comingSoon: false,
    downloadUrl: '/sistema-luz-cuantica.pdf',
  },
];
